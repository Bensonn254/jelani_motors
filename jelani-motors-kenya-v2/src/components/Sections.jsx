...
export function AboutSection() {
  return (
    <>
      {/* Part 1 */}
      <section id="about" className="py-20 bg-white section-hidden">
        <div className="max-w-[1280px] mx-auto px-10 max-sm:px-5">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <BtnRed href="#fleet">See Our Fleet <BtnIconRed /></BtnRed>
            </div>
      ...
      <section className="pb-20 bg-white section-hidden">
        <div className="max-w-[1280px] mx-auto px-10 max-sm:px-5">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
...
export function HowWeWork() {
  return (
    <section id="how" className="grid lg:grid-cols-2 min-h-[520px] section-hidden" style={{ background: '#111' }}>
...
export function ServicesSection() {
  return (
    <section id="services" className="py-20 bg-white section-hidden">
      <div className="max-w-[1280px] mx-auto px-10 max-sm:px-5">
