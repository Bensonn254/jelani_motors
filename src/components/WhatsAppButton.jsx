...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-4 md:right-6 z-[400] flex items-center gap-3 select-none"
      ...
      {/* Green circle button container */}
      <div className="relative flex items-center justify-center">
        {/* Pulse ring (placed inside the circular button's boundary logic, behind the icon) */}
        <span
        ...
        {/* Actual Green circle button */}
        <div
          className="w-14 h-14 rounded-full flex items-center justify-center transition-transform duration-200 relative z-10"
          style={{
            background: '#25D366',
