...
export function CTABanner() {
  return (
    <Reveal as="section" className="relative overflow-hidden min-h-[420px] flex items-center justify-center text-center">
      ...
      <div className="relative z-10 px-10 py-20 max-w-[760px] max-sm:px-5">
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap">
          <a href="#"
            onClick={(e) => { e.preventDefault(); window.dispatchEvent(new CustomEvent('show-coming-soon', { detail: { page: 'Browse Cars' } })) }}
